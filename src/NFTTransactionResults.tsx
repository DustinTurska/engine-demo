...
interface NFTTransactionResults {
  queueId: string;
...
interface NFTTransactionResultsProps {
  results: NFTTransactionResults[];
}
...
export function NFTTransactionResults({ results }: NFTTransactionResultsProps) {
